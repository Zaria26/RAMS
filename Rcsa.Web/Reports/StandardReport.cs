...
namespace Rcsa.Web.Reports {
    ...
    public class StandardReport : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Rcsa.Web.Reports.StandardReport.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedStandardReport : Component, ICachedReport {
        
        public CachedStandardReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            StandardReport rpt = new StandardReport();
            rpt.Site = this.Site;
            return rpt;
        }
